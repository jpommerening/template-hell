...
namespace SIUnits {
  ...
  template <> const char * const Hz::name = "Hz";
  template <> const char * const rad::name = "rad";
  template <> const char * const sr::name = "sr";
  template <> const char * const N::name = "N";
  template <> const char * const Pa::name = "Pa";
  template <> const char * const J::name = "J";
  ...
  template <> const char * const H::name = "H";
  template <> const char * const lm::name = "lm";
